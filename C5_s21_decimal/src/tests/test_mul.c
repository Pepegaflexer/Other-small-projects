...
START_TEST(s21_mul_test_1) {
  for (size_t i = 0; i < sizeof(num1) / sizeof(s21_decimal); ++i) {
    s21_decimal value_1 = num1[i];
    s21_decimal value_2 = num2[i];
    s21_decimal tmp;
    int ans = s21_mul(value_1, value_2, &tmp);
...
START_TEST(s21_mul_test_2) {
  for (size_t i = 0; i < sizeof(err_num1) / sizeof(s21_decimal); ++i) {
    s21_decimal value_1 = err_num1[i];
    s21_decimal value_2 = err_num2[i];
    s21_decimal tmp;
    int ans = s21_mul(value_1, value_2, &tmp);
    ck_assert_int_eq(ans, err_result[i]);
  }
}
END_TEST
